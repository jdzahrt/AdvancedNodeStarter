...
describe('When logged in', async () => {
    ...
    describe('And using valid inputs', async () => {
        beforeEach(async () => {
            await page.type('.title input', 'My Title First');
            await page.type('.content input', 'My Content First');
        ...
        test('Submitting then saving adds blog to index page', async () => {
            ...
            expect(title).toEqual('My Title First');
            expect(content).toEqual('My Content First');
        })
    });
...
describe('When not logged in', async () => {
    it('User cannot create blog post ', async () => {
